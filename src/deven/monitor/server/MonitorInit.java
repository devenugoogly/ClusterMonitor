...
public class MonitorInit extends ChannelInitializer<SocketChannel>{

		boolean compress = false;
		MonitorQueue queue;
		public MonitorInit(boolean enableCompression, MonitorQueue qu) {
			super();
		...
		public void initChannel(SocketChannel ch) throws Exception {
			...
			pipeline.addLast("handler", new MonitorHandler(queue));
		}
